    ...
    case 'MultiPolygon':
      return {
        ...
        coordinates: Array.isArray(geom.coordinates)
          ? geom.coordinates.map(shiftMulti)
          : geom.coordinates,
      };
    default:
      return geom;
...
/**
 * GeoJSON overlay that fetches and caches remote FeatureCollections, with
 * optional bbox filtering and world copies for seamless panning.
 */
